  ...
  render () {
    ...
    var list = skills.reduce((acc, cur, i) => {
      if (
        ...
        var item = <SkillItem basic={!this.props.skills.find(el => el == 'html2')} clickable={props.skills.find(el => el == 'css1')} skill={cur} key={i} onSkillPurchased={this.props.onSkillPurchased} />
