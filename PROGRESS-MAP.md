...
| id           | name                                               | cost  | trigger | multiplier      | prerequisites | description                                                                                                                                  | effects                                                                         |                                    
| ------------ | -------------------------------------------------- | ----- | ------- | --------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| paint        | Paint the office                                   | 250   | 250     | `G` 0.1         | ...           | The concrete and white dry wall are starting to hurt moral. Maybe a nice pastel would spruce up the place.                                   | Changes background.
...
| pitch        | Pitch to investors                                 | 250   | 250     | `G` 0.1         | ...           | Your initial capital is drying up but there's no way an investor wouldn't see the value in your startup. Whatever it is.                     | ...
| kickstarter  | Create a kickstarter campaign                      | 250   | 250     | `G` 0.1         | pitch         | The pitch didn't go as planned. Time to grovel.                                                                                              | ...
...
| monetize     | Monetize with ads                                  | 55    | 45      | `G` 0.05        | ...           | You're getting views but your wallet is getting emptier because of server costs...running a startup is harder than your thought.             | Advertisements.
